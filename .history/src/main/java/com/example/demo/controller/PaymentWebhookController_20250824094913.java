...
public class PaymentWebhookController {
    ...
    public ResponseEntity<String> webhook(@RequestHeader(value = "X-Payment-Secret", required = false) String secret,
        ...
        try {
            ...
            // Update booking status: if previously not paid -> mark as paid room (partial semantics),
            // otherwise mark fully paid when appropriate. Simpler: append 'Đã thanh toán' if not present.
