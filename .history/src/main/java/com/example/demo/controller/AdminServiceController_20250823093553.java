...
public class AdminServiceController {
    ...
    // NOTE: previously this moved pending services directly to COMPLETED. Change to mark them as PROCESSING
    // so they follow the normal flow (Chờ xác nhận -> Đang xử lý -> Hoàn thành).
        ...
        try {
            ...
            if (updatedCount > 0) {
                redirectAttributes.addFlashAttribute(FLASH_SUCCESS,
                    "Đã cập nhật " + updatedCount + " dịch vụ sang 'Đang xử lý' cho booking #" + bookingId);
            } else {
