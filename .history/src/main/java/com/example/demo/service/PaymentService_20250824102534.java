...
public class PaymentService {
    ...
    public Payment save(Payment p) {
        try {
            ...
            // Possible unique constraint on providerRef was violated (concurrent provider callbacks).
            if (p.getProviderRef() != null) {
                return paymentRepository.findByProviderRef(p.getProviderRef()).orElseThrow(() -> ex);
            }
            throw ex;
        }
    }
