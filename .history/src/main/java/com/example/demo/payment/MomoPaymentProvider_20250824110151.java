    ...
    public Map<String, String> createCheckout(Payment payment) {
        ...
        if (props != null && props.getMomo() != null && props.getMomo().getEndpoint() != null) {
            try {
                ...
                mac.init(new javax.crypto.spec.SecretKeySpec(momo.getSecretKey().getBytes(java.nio.charset.StandardCharsets.UTF_8), "HmacSHA256"));
                byte[] digest = mac.doFinal(raw.getBytes(java.nio.charset.StandardCharsets.UTF_8));
