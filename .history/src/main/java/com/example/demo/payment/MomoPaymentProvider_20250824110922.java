 ...
 * Real HTTP calls to MOMO's API are performed when configured via properties. Example properties:
...
public class MomoPaymentProvider implements PaymentProvider {
    ...
    // If MOMO is configured with endpoint and keys, call real API
